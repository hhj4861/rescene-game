...
/**
 * 멤버 스프라이트시트 프레임 규격(캐릭터 v2, 3등신 32×64 도트를 40×64 프레임 아래 가운데에 둔다 — 소품 여유 4px).
 * 빌드 도구(tools/build-sprites)와 Phaser 로더가 공유한다.
 */
export const PLAYER_FRAME = { width: 40, height: 64 } as const;

/** 프레임 인덱스 0~14. `attack`은 체인 1·2·3타 프레임을 통째로 재생하는 웨이브 1 호환 키다. */
export const PLAYER_ANIMS = {
  ...
  attack:   { frames: [8, 9, 10], frameRate: 12, repeat: 0 },
...
/** NPC 시트: 멤버와 같은 40×64 템플릿, 대기 2프레임. */
export const NPC_FRAME = { width: 40, height: 64 } as const;
