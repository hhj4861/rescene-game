...
export const CH0_CUTSCENES: CutsceneDef[] = [
  ...
  { id: 'ch0_intro_liv', title: '장면 0 — 수원, 2023년', lines: ['여러 기획사의 합격 통보가 쌓였다.', '하지만 리브는 아직 시작할 곳을 고르지 못했다.'] },
  { id: 'ch0_intro_minami', title: '장면 0 — 치바, 2021년', lines: ['1048대 1을 뚫고 방과후 설렘 파이널까지 갔지만 데뷔조에 들지 못했다.', '일본으로 돌아간 미나미는 다시 짐을 쌌다.'] },
  { id: 'ch0_intro_may', title: '장면 0 — 고양, 2023년', lines: ['픽플래닛 아카데미 홍대점.', '오디션 순서를 기다리는 메이의 손이 떨렸다.'] },
